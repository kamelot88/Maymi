// Начало_Какая-то хрень, без которой Edg ругаеться
[
    {
        ...
        "device": {
            ...
            "user-agent": "Mozilla/5.0 (Windows Phone 10.0; Android 6.0.1; Microsoft; Lumia 650) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.116 Mobile Safari/537.36 Edge/15.15063",
            "type": "phone",
            "modes": []
        }
    },
    ...
    },
    {
        ...
        "device": {
            ...
            "user-agent": "Mozilla/5.0 (Windows Phone 10.0; Android 6.0.1; Microsoft; Lumia 950XL) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/52.0.2743.116 Mobile Safari/537.36 Edge/15.15063",
            "type": "phone",
            "modes": []
        }
    },
...
// Конец_Какая-то хрень, без которой Edg ругаеться
...
//  устройства (ширина экрана менее 1024px) и для ПК (ширина экрана, более 1024px)
	...
	// Начало_Кнопка добавляет блок фотографий в галерею
	$('#view_all_gallery').click(function(){
		let content = '<div id="gallery_line" class="main_flex__nowrap flex__jcontent_between"><div id="box_img_gallary"><img src="img/Layer_46.jpg" alt="" class="img_1"></div><div id="box_img_gallary"><img src="img/Layer_47.jpg" alt="" class="img_2"></div></div><div id="name_gallery">Marina Palms /<span class="blue">North Miami Beach, FL 33162</span></div>';
		$('#gallery_box').append(content);
		$(this).remove();
	});
	// Конец_Кнопка добавляет блок фотографий в галерею
